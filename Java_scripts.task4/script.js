...
//     let vurma = number1 * number2;
//     return vurma;
// }
// console.log(multiply(2,3));

// function subtruct(number1,number2){
//     let delet = number1 - number2;
//     return delet;
...
//         if(arr%2==0){
//             console.log("bu eded bolunur 2ye");

//         }
//         else if(arr%3==0){
//             console.log("bu eded bolunur 3e");

//         }
//         else if(arr%5==0){
//             console.log("bu eded bolunur 5e");
...
//         for (let i = 0; i < arr.length; i++) {
//         if(arr[i].qiymet>60){
//             console.log("60dan yuxari olduqu ucun kecdi");

//         }
//         else if(arr[i].qiymet<60){
//             console.log("60dan asaqi olduqu ucun kecmedi");

//         }

//         }
//     }
// telebe([{name:"Emin",qiymet:90},
//     {name:"rustem",qiymet:50},
//     {name:"yadiq",qiymet:70} ])

// 15. Kəmiyyət Yoxlanması
// Verilmiş bir ədədin 10-dan kiçik, bərabər və ya böyük olduğunu yoxlayan bir funksiya yaradın.
// function eded(num){
//     if(num>10){
//         console.log(`${num} boyukdur 10-dan`);

//     }
//     else if(num<10){
//         console.log(`${num} kicikdir 10-dan`);

//     }
//     else if(num==10){
//         console.log(`${num} beraberdir 10-a`);
...
//         console.log(`${arr} bu herf seslidir`);

//     }

//     else{
//         console.log("Bu sesli herf deyil");
...
//     }
//     console.log(`musbet ededler:${musbet_count}`);
//     console.log(`menfi ededler:${menfi_count}`);
// }
// nums([1,23,4])
...
//         if(produtcs[i].id % 2 == 1){
//             console.log(produtcs[i].title);
//         }
...
//         if(produtcs[i].price>50){
//             console.log(produtcs[i].category);
//         }
...
//         if(produtcs[i].rating.count<120){
//             console.log(produtcs[i].title);
//         }
